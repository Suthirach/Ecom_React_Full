...
const ProductCard = ({ item }) => {
    ...
    return (
            ...
            <div className="hover:duration-200 flex flex-col hover:scale-105">
                <div className="   border rounded-lg shadow-lg p-4 w-60 bg-white    hover:duration-200 flex flex-col hover:scale-105 ">
                    {/* Image Section */}
                    <div className="mb-4">
