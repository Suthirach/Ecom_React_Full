...
-- AddForeignKey
ALTER TABLE `Order` ADD CONSTRAINT `Order_rderedById_fkey` FOREIGN KEY (`rderedById`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
